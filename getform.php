...
$my_reqest = file_get_contents('http://-/api/add_lead?'.http_build_query($my_data)); 
...
if (isset($post_data['phone']) and ($post_data['phone'] !== '') ) {
	...
	file_get_contents('http://-/api/update_lead?'.http_build_query($upd));
